package com.collectionsframework.policymanagementsystemusingmap;
...
public class InsuranceSystem {
    ...
    public static void main(String[] args) {
        ...
        manager.addPolicy(new Policy("P101", "Piyosh", LocalDate.now().plusDays(10), 5000));
        manager.addPolicy(new Policy("P102", "Amit Sharma", LocalDate.now().plusDays(40), 8000));
        manager.addPolicy(new Policy("P103", "Piyosh", LocalDate.now().minusDays(5), 6000));
